	...
	<div class="row">
		...
		<div class="col-sm-12 col-md-8">
			<div class="media mt-0">
			    ...
			    <h2 class="media-heading"><?php echo \JText::_('COM_FAQBOOKPRO'); ?> <span class="badge badge-success">Free</span></h2>
		...
		<div class="col-sm-12 col-md-4">
			...
			<div class="dashboard-module">
				<div class="card mb-3">
					<div class="card-header">
						<h4 class="m-0"><?php echo \JText::_('COM_FAQBOOKPRO_DASHBOARD_SIDEBAR_ABOUT'); ?></h4>
					</div>
					<div class="card-body p-0">
						<ul class="list-group list-group-flush">
							<li class="list-group-item">
								<div><?php echo \JText::_('COM_FAQBOOKPRO_DASHBOARD_SIDEBAR_EXTENSION'); ?></div>
								<div><a href="https://www.minitek.gr/joomla/extensions/minitek-faq-book" target="_blank"><?php echo \JText::_('COM_FAQBOOKPRO'); ?></a></div>
							</li>
							<li class="list-group-item">
							...
							<li class="list-group-item">
								<div><?php echo \JText::_('COM_FAQBOOKPRO_DASHBOARD_SIDEBAR_DEVELOPER'); ?></div>
								<div><a href="https://www.minitek.gr/" target="_blank">Minitek</a></div>
							</li>
							<li class="list-group-item">
								<div><?php echo \JText::_('COM_FAQBOOKPRO_DASHBOARD_SIDEBAR_LICENSE'); ?></div>
			...
			<div class="dashboard-module">
				<div class="card mb-3">
					<div class="card-header">
						<h4 class="m-0"><?php echo \JText::_('COM_FAQBOOKPRO_DASHBOARD_SIDEBAR_QUICK_LINKS'); ?></h4>
					</div>
					<div class="card-body p-0">
						<ul class="list-group list-group-flush">
							<li class="list-group-item">
							...
							<li class="list-group-item">
								...
								<span>
									<a href="https://www.minitek.gr/support/forum/joomla/minitek-faq-book" target="_blank"><?php echo \JText::_('COM_FAQBOOKPRO_DASHBOARD_SIDEBAR_TECHNICAL_SUPPORT'); ?></a>
								</span>
							</li>
							<li class="list-group-item">
							...
							<li class="list-group-item">
								...
								<span>
									<a href="https://www.minitek.gr/joomla/extensions/minitek-faq-book#subscriptionPlans" target="_blank"><?php echo JText::_('COM_FAQBOOKPRO_DASHBOARD_UPGRADE_TO_PRO'); ?></a>
								</span>
							</li>
						</ul>
					</div>
