		...
		<?php if ($published >= 0) { ?>
			<div class="form-group col-md-6">
				<div class="controls">
					...
					<label id="batch-choose-action-lbl" for="batch-topic-id">
						<?php echo Text::_('COM_FAQBOOKPRO_BATCH_TOPICS_MENU_LABEL'); ?>
					</label>
					...
					<div id="batch-copy-move" class="control-group radio">
						<fieldset id="batch-copy-move-id">
							<legend><?php echo Text::_('COM_FAQBOOKPRO_BATCH_ACTION_TO_PERFORM'); ?></legend>
