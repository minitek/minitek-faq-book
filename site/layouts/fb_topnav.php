...
?><div class="fbTopNavigation_core_outer">
  <div class="fbTopNavigation_core">
    <div class="fbTopNavigation_wrap">
      <ul class="fbTopNavigation_root fb-hidden-phone">
        ...
        ?><li id="top_liid_home" class="NavTopUL_item NavTopUL_section NavTopUL_firstChild <?php echo $class; ?>">
            <a class="NavTopUL_link" href="<?php echo Route::_(RouteHelper::getSectionRoute($sectionId)); ?>" onclick="return false;">
              <?php
              if ($topnav_sections) {
    ...
    <div class="NavTopUL_buttons">
      ...
      ?><div class="show_menu"><a href="#" onclick="return false;" class="btn btn-default"><i class="fas fa-bars"></i></a></div>
      <?php
      }
