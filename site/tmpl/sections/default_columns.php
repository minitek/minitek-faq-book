...
<div class="fbContent_sections">
			...
			foreach ($this->sections as $key => $section) {
				...
				<div class="fb_column <?php echo $column_class; ?> <?php echo $sectionParams->get('section_class', ''); ?>">
					<div class="card h-100 <?php echo $card_class; ?>">
						<div class="card-body">
							<?php if ($sectionParams->get('section_image', 0) && $this->params->get('sections_image', true)) { ?>
							...
							if ($this->params->get('sections_title', true)) { ?>
								<h4 class="fb_column_header fs-5">
									...
									<?php if ($this->params->get('sections_section_count', true)) { ?>
								...
								<div class="fb_column_topics">
									<?php foreach ($section->topics as $topic) { ?>
										<div class="fb_column_topic">
											...
											<?php if ($this->params->get('sections_topics_count', true)) { ?>
	...
	if ($this->params->get('sections_custom', '')) { ?>
		<div class="fbContent_sections_custom">
			<?php echo $this->params->get('sections_custom'); ?>
		</div>
	<?php } ?>
</div>